...
unsigned int nTargetSpacing = 90; // 1.5 minute per block
...
const string strMessageMagic = "dTaler Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 < 101)
    {
      nSubsidy = 1 * COIN;
    }
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
	...
	//printf(">> Height = %d, fProofOfStake = %d, nInterval = %"PRId64", nTargetSpacing = %d, nActualSpacing = %d\n", 
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dTaler", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "#328830-00000000000000000f31e49a0a00a56d240da3fc2b6910100412268ac285e6c5";
        CTransaction txNew;
        txNew.nTime = 1415290500;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415290500;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1100292 : 1438837;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xaad3ca64e88be42f2c2c6c59d1a30aca341ef9bdbebeaa6e9c864dbdfd06fad0"));
